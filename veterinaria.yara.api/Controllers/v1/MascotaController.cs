...
namespace veterinaria.yara.api.Controllers.v1
{
    ...
    public class MascotaController : BaseApiController
    {
        ...
        public async Task<ActionResult<PaginationFilterResponse<MascotaDTO>>> ConsultarMascotas(int start, Int16 lenght, int estado, DateTime fechaInicio, DateTime fechaFin, Guid idUsuario,
        CancellationToken cancellationToken)
        {
            var response = await _mascotaRepository.ConsultarMascotas(start, lenght, estado, fechaInicio, fechaFin, idUsuario, cancellationToken);
