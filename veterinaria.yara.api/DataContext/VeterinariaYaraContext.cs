...
{
    public partial class VeterinariaYaraContext : DbContext
    {
        public VeterinariaYaraContext()
        {
        }

        public VeterinariaYaraContext(DbContextOptions<VeterinariaYaraContext> options)
            : base(options)
        {
        }
